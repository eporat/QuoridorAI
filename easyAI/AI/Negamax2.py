...
class Negamax2:
    ...
    def __init__(self, depth, scoring, win_score=+inf, shuffle=False, tt=None):
        self.depth = depth
    ...
    def __call__(self, game):
        ...
        """
        self.alpha = negamax(game, self.depth, self.depth, self.scoring,
                     -self.win_score, +self.win_score, self.population, self.shuffle)
        return game.ai_move
