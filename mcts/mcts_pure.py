...
class MCTS(object):
    ...
    def __init__(self, policy_value_fn, c_puct=5, n_playout=10000):
        """
        policy_value_fn: a function that takes in a game game and outputs
    ...
    def _playout(self, game):
        ...
        game is modified in-place, so a copy must be provided.
        """
        node = self._root
        while(1):
            if node.is_leaf():
...
class MCTSPlayer(object):
    ...
    def __init__(self, c_puct=5, n_playout=1000, win_score=1000):
